 ...
 * * Estructura actual:
 * - id: Número de la Pokédex Nacional (útil para ordenamiento o futuras integraciones de API).
 * - name: Nombre del Pokémon en MAYÚSCULAS (requerido para coincidir con el nombre de las imágenes y la validación).
 * * ¿Cómo expandir esto en el futuro? (Ejemplo)
 * { id: 1, name: "BULBASAUR", gen: 1, types: ["Planta", "Veneno"], difficulty: "Fácil" }
 */
...
const pokemonList = [
    ...
    { id: 29, name: "NIDORANfE" },
    { id: 30, name: "NIDORINA" },
    { id: 31, name: "NIDOQUEEN" },
    { id: 32, name: "NIDORANmA" },
    { id: 33, name: "NIDORINO" },
    { id: 34, name: "NIDOKING" },
    { id: 35, name: "CLEFAIRY" },
    { id: 36, name: "CLEFABLE" },
    ...
    { id: 984, name: "GREATTUSK" },
    { id: 985, name: "SCREAMTAIL" },
    { id: 986, name: "BRUTEBONNET" },
    { id: 987, name: "FLUTTERMANE" },
    { id: 988, name: "SLITHERWING" },
    { id: 989, name: "SANDYSHOCKS" },
    { id: 990, name: "IRONTREADS" },
    { id: 991, name: "IRONBUNDLE" },
    { id: 992, name: "IRONHANDS" },
    { id: 993, name: "IRONJUGULIS" },
    { id: 994, name: "IRONMOTH" },
    { id: 995, name: "IRONTHORNS" },
    { id: 996, name: "FRIGIBAX" },
    { id: 997, name: "ARCTIBAX" },
    { id: 998, name: "BAXCALIBUR" },
    { id: 999, name: "GIMMIGHOUL" },
    { id: 1000, name: "GHOLDENGO" },
    { id: 1001, name: "WOCHIEN" },
    { id: 1002, name: "CHIENPAO" },
    { id: 1003, name: "TINGLU" },
    { id: 1004, name: "CHIYU" },
    { id: 1005, name: "ROARINGMOON" },
    { id: 1006, name: "IRONVALIANT" },
    { id: 1007, name: "KORAIDON" },
    { id: 1008, name: "MIRAIDON" },
    { id: 1009, name: "WALKING WAKE" },
    { id: 1010, name: "IRONLEAVES" },
    ...
    { id: 1020, name: "GOUGINGFIRE" },
    { id: 1021, name: "RAGINGBOLT" },
    { id: 1022, name: "IRONBOULDER" },
    { id: 1023, name: "IRONCROWN" },
